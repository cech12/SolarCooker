...
public final class ModBlocks {
    ...
    private static final Block REFLECTOR_BLOCK = register(Constants.REFLECTOR_NAME, new ReflectorBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0F).sound(SoundType.WOOD)));
    ...
    static {
        ...
        Constants.REFLECTOR_BLOCK = () -> REFLECTOR_BLOCK;
