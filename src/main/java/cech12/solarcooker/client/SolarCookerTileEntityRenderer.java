...
public class SolarCookerTileEntityRenderer extends TileEntityRenderer<SolarCookerTileEntity> {
    ...
    @Override
    public void render(SolarCookerTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        if (world != null) {
            ...
            if (block instanceof AbstractSolarCookerBlock) {
                ...
                */
                ...
                this.renderModels(matrixStackIn, ivertexbuilder, this.singleLid, this.singleLatch, this.singleBottom, this.singleInner, 1, combinedLightIn, combinedOverlayIn);
